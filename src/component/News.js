...
export class News extends Component {
  ...
  async componentDidMount(){ 
    let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=1bbad9d74ba6431b95e7d9dc1f8ac4b3&page=1pageSize=20";
 ...
 handlePrevClick = async ()=>{
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=1bbad9d74ba6431b95e7d9dc1f8ac4b3&page=${this.state.page - 1}&pageSize=20`;
    let data = await fetch(url);
    let parsedData = await data.json()
    console.log(parsedData);  
    this.setState({
...
render() { 
    return (
        <div className="container my-3">
            ...
            <button disabled={this.state.page<=1} type="button"  className="btn btn-outline-info" onClick={this.handlePrevClick}> &larr; Previous</button>
